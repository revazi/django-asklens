...
| Draft contract schemas and conformance | [`contracts/_generation.py`](../django_asklens/contracts/_generation.py), [`contracts/_models.py`](../django_asklens/contracts/_models.py), [`contracts/schemas/`](../django_asklens/contracts/schemas/) | [`test_schemas.py`](../tests/contracts/test_schemas.py), [`test_containment_schema.py`](../tests/contracts/test_containment_schema.py), [`test_replay.py`](../tests/conformance/test_replay.py) | Generated/packaged schema parity, independent Draft 2020-12 validation, language-neutral fixture shape, and parser/facade rejection consistency; schema validity is never execution authority. |
